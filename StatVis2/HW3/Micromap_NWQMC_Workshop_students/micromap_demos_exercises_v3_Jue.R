#Linked Micromap Demos and Exercises
#Program:  micromap_demos_exercises_v3_Jue.R
#Programmer:  Michael McManus

#Date:  2013-10-21
#Date Modified:  2014-04-04 using micromap version 1.8
#Updated: 2018-02-02 by Juergen Symanzik
...
#sets you can use to make a four panel draft micromap plot of the estimated median
#pH.  The four panels include a dot legend, names of ecoregions, estimated median pH, and maps.
...
mmplot(stat.data=cotton,
       ...
       panel.data=list(NA, 'state', 'Yield', NA),
       ord.by='Yield',
       rev.ord=TRUE,
       grouping=4,
